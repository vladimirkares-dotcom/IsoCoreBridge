...
## E1–P5 – Left nav stabilization (Completed)

**Changes performed:**
- Zrušen pokročilý ControlTemplate s hover/pressed/focus + accent barem (E1–P3/E1–P4) kvůli runtime AccessViolationException ve WinUI 3.
- IcbdMenuButton vrácen na jednoduchý, template-less styl (bez VSM), ponechává VL4D-aligned spacing/typografii z E1–P1/E1–P2.
- Pokročilé Forge efekty pro navigaci budou znovu navrženy v budoucím bloku (mimo E1).
...
**Build result:**
- `dotnet build src\IsoCore.App\IsoCore.App.csproj -c Debug -r win-x64`  
  → success, 0 errors, 1 warning (locked IsoCore.Domain.dll).

**Status:**
- E1–P1 až E1–P5 hotovo; aktuální baseline navigačního UI je stabilní. Další práce: nový blok pro pokročilé Forge vizuální efekty v navigaci.
